...
ActiveRecord::Schema.define(version: 2020_05_08_080517) do

  create_table "active_admin_comments", options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "namespace"
    t.text "body"
  ...
  create_table "admin_users", options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "brands", options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "order_products", options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "products_stores", id: false, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "product_id", null: false
